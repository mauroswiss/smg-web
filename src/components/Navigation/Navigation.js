...
import { LOCALSTORAGE_AUTH_KEY, HOST_SERVER } from '../../constants';
          ...
          ? <ul>
              <li>
                <ExternalLink
                  ...
                  target="_self"
                  to={`${HOST_SERVER}smgnewsite/prepaga/index.php`}
                >
                  PERSONAS
                </ExternalLink>
              </li>
              ...
              <li>
                <ExternalLink
                  className={s.link}
                  target="_self"
                  to={`${HOST_SERVER}smgnewsite/prepagaempresas/index.php`}
                >
                  EMPRESAS
                </ExternalLink>
              </li>
              ...
              <ExternalLink
                className={s.link}
                target="_self"
                to={`${HOST_SERVER}smgnewsite/prestadores/home`}
              >
                PRESTADORES
              </ExternalLink>
              <li>
