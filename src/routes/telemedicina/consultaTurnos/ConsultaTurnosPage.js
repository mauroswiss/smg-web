...
import ConsultaTurnosPageUserLoggedIn from './ConsultaTurnosPageUserLoggedIn';
...
class ConsultaTurnosPage extends React.Component {
  constructor() {
    super();
    this.state = {
  ...
  render() {
    if (
      ...
      return <ConsultaTurnosPageUserLoggedIn />;
    }
...
export default connect(mapStateToProps, null)(withStyles()(ConsultaTurnosPage));
