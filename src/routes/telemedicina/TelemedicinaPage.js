...
import TelemedicinaPageUserLoggedIn from './TelemedicinaPageUserLoggedIn';
...
class TelemedicinaPage extends React.Component {
  constructor() {
    super();
    this.state = {
  ...
  render() {
    if (
      ...
      return <TelemedicinaPageUserLoggedIn />;
    }
...
export default connect(mapStateToProps, null)(withStyles()(TelemedicinaPage));
